...
class dailyoutlook extends StatefulWidget {
  const dailyoutlook({Key? key}) : super(key: key);

  @override
  State<dailyoutlook> createState() => _dailyoutlookState();
}

class _dailyoutlookState extends State<dailyoutlook> {
  @override
